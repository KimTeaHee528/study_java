package com.bnt.study.ch08.first;

public class RemoteControlExample {

	public static void main(String[] args) {

		RemoteControl remoteControl = new Television();  // Television 선언할때 인터페이스인 RemoteControl형태로 선언
...
//		RemoteControl remoteControl1;	 //인터페이스 변수 선언
//		remoteControl1 = new Audio();	 //구현객체로  초기화
